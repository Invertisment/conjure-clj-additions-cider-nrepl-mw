...
local _2amodule_name_2a = "conjure-additions.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("conjure-additions.aniseed.core"), autoload("conjure-additions.aniseed.compile"), autoload("conjure-additions.aniseed.fennel"), autoload("conjure-additions.aniseed.fs"), autoload("conjure-additions.aniseed.nvim")
