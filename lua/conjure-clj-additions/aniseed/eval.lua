...
local _2amodule_name_2a = "conjure-clj-additions.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("conjure-clj-additions.aniseed.core"), autoload("conjure-clj-additions.aniseed.compile"), autoload("conjure-clj-additions.aniseed.fennel"), autoload("conjure-clj-additions.aniseed.fs"), autoload("conjure-clj-additions.aniseed.nvim")
