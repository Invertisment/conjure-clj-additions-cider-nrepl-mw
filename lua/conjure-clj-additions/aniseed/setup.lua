...
local _2amodule_name_2a = "conjure-clj-additions.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("conjure-clj-additions.aniseed.core"), autoload("conjure-clj-additions.aniseed.env"), autoload("conjure-clj-additions.aniseed.eval"), autoload("conjure-clj-additions.aniseed.nvim")
