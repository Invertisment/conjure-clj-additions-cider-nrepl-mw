...
local _2amodule_name_2a = "jump-to-clj-test.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("jump-to-clj-test.aniseed.core"), autoload("jump-to-clj-test.aniseed.env"), autoload("jump-to-clj-test.aniseed.eval"), autoload("jump-to-clj-test.aniseed.nvim")
