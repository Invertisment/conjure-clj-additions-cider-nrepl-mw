package.preload["jump-to-clj-test.aniseed.fennel.repl"] = package.preload["jump-to-clj-test.aniseed.fennel.repl"] or function(...)
  local utils = require("jump-to-clj-test.aniseed.fennel.utils")
  local parser = require("jump-to-clj-test.aniseed.fennel.parser")
  local compiler = require("jump-to-clj-test.aniseed.fennel.compiler")
  local specials = require("jump-to-clj-test.aniseed.fennel.specials")
  local view = require("jump-to-clj-test.aniseed.fennel.view")
...
package.preload["jump-to-clj-test.aniseed.fennel.specials"] = package.preload["jump-to-clj-test.aniseed.fennel.specials"] or function(...)
  local utils = require("jump-to-clj-test.aniseed.fennel.utils")
  local view = require("jump-to-clj-test.aniseed.fennel.view")
  local parser = require("jump-to-clj-test.aniseed.fennel.parser")
  local compiler = require("jump-to-clj-test.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "jump-to-clj-test.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["jump-to-clj-test.aniseed.fennel.compiler"] = package.preload["jump-to-clj-test.aniseed.fennel.compiler"] or function(...)
  local utils = require("jump-to-clj-test.aniseed.fennel.utils")
  local parser = require("jump-to-clj-test.aniseed.fennel.parser")
  local friend = require("jump-to-clj-test.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["jump-to-clj-test.aniseed.fennel.friend"] = package.preload["jump-to-clj-test.aniseed.fennel.friend"] or function(...)
  local utils = require("jump-to-clj-test.aniseed.fennel.utils")
...
package.preload["jump-to-clj-test.aniseed.fennel.parser"] = package.preload["jump-to-clj-test.aniseed.fennel.parser"] or function(...)
  local utils = require("jump-to-clj-test.aniseed.fennel.utils")
  local friend = require("jump-to-clj-test.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["jump-to-clj-test.aniseed.fennel.view"] = package.preload["jump-to-clj-test.aniseed.fennel.view"] or function(...)
...
package.preload["jump-to-clj-test.aniseed.fennel.utils"] = package.preload["jump-to-clj-test.aniseed.fennel.utils"] or function(...)
  local view = require("jump-to-clj-test.aniseed.fennel.view")
  local version = "1.1.0"
...
utils = require("jump-to-clj-test.aniseed.fennel.utils")
local parser = require("jump-to-clj-test.aniseed.fennel.parser")
local compiler = require("jump-to-clj-test.aniseed.fennel.compiler")
local specials = require("jump-to-clj-test.aniseed.fennel.specials")
local repl = require("jump-to-clj-test.aniseed.fennel.repl")
local view = require("jump-to-clj-test.aniseed.fennel.view")
...
do
  ...
  local module_name = "jump-to-clj-test.aniseed.fennel.macros"
  local _
