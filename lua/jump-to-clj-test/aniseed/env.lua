...
local _2amodule_name_2a = "jump-to-clj-test.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("jump-to-clj-test.aniseed.compile"), autoload("jump-to-clj-test.aniseed.fennel"), autoload("jump-to-clj-test.aniseed.fs"), autoload("jump-to-clj-test.aniseed.nvim")
