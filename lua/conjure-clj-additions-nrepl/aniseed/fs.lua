...
local _2amodule_name_2a = "conjure-clj-additions-nrepl.aniseed.fs"
local _2amodule_2a
do
...
local a, nvim = autoload("conjure-clj-additions-nrepl.aniseed.core"), autoload("conjure-clj-additions-nrepl.aniseed.nvim")
