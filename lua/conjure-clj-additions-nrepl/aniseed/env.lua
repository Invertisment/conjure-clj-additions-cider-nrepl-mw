...
local _2amodule_name_2a = "conjure-clj-additions-nrepl.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("conjure-clj-additions-nrepl.aniseed.compile"), autoload("conjure-clj-additions-nrepl.aniseed.fennel"), autoload("conjure-clj-additions-nrepl.aniseed.fs"), autoload("conjure-clj-additions-nrepl.aniseed.nvim")
