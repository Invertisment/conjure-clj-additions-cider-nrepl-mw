...
local _2amodule_name_2a = "conjure-clj-additions-nrepl.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("conjure-clj-additions-nrepl.aniseed.core"), autoload("conjure-clj-additions-nrepl.aniseed.fennel"), autoload("conjure-clj-additions-nrepl.aniseed.fs"), autoload("conjure-clj-additions-nrepl.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "conjure-clj-additions-nrepl.aniseed.macros"
  local filename
  do
