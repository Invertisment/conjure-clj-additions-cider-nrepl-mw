...
local _2amodule_name_2a = "conjure-clj-additions-nrepl.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("conjure-clj-additions-nrepl.aniseed.core"), autoload("conjure-clj-additions-nrepl.aniseed.fs"), autoload("conjure-clj-additions-nrepl.aniseed.nvim"), autoload("conjure-clj-additions-nrepl.aniseed.string")
...
local function impl()
  local compiler = require("conjure-clj-additions-nrepl.aniseed.deps.fennel")
