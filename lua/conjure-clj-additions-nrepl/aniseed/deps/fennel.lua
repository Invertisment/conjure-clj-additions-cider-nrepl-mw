package.preload["conjure-clj-additions-nrepl.aniseed.fennel.repl"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.repl"] or function(...)
  local utils = require("conjure-clj-additions-nrepl.aniseed.fennel.utils")
  local parser = require("conjure-clj-additions-nrepl.aniseed.fennel.parser")
  local compiler = require("conjure-clj-additions-nrepl.aniseed.fennel.compiler")
  local specials = require("conjure-clj-additions-nrepl.aniseed.fennel.specials")
  local view = require("conjure-clj-additions-nrepl.aniseed.fennel.view")
...
package.preload["conjure-clj-additions-nrepl.aniseed.fennel.specials"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.specials"] or function(...)
  local utils = require("conjure-clj-additions-nrepl.aniseed.fennel.utils")
  local view = require("conjure-clj-additions-nrepl.aniseed.fennel.view")
  local parser = require("conjure-clj-additions-nrepl.aniseed.fennel.parser")
  local compiler = require("conjure-clj-additions-nrepl.aniseed.fennel.compiler")
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "conjure-clj-additions-nrepl.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["conjure-clj-additions-nrepl.aniseed.fennel.compiler"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.compiler"] or function(...)
  local utils = require("conjure-clj-additions-nrepl.aniseed.fennel.utils")
  local parser = require("conjure-clj-additions-nrepl.aniseed.fennel.parser")
  local friend = require("conjure-clj-additions-nrepl.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["conjure-clj-additions-nrepl.aniseed.fennel.friend"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.friend"] or function(...)
  local utils = require("conjure-clj-additions-nrepl.aniseed.fennel.utils")
...
package.preload["conjure-clj-additions-nrepl.aniseed.fennel.parser"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.parser"] or function(...)
  local utils = require("conjure-clj-additions-nrepl.aniseed.fennel.utils")
  local friend = require("conjure-clj-additions-nrepl.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["conjure-clj-additions-nrepl.aniseed.fennel.view"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.view"] or function(...)
...
package.preload["conjure-clj-additions-nrepl.aniseed.fennel.utils"] = package.preload["conjure-clj-additions-nrepl.aniseed.fennel.utils"] or function(...)
  local view = require("conjure-clj-additions-nrepl.aniseed.fennel.view")
  local version = "1.3.0"
...
utils = require("conjure-clj-additions-nrepl.aniseed.fennel.utils")
local parser = require("conjure-clj-additions-nrepl.aniseed.fennel.parser")
local compiler = require("conjure-clj-additions-nrepl.aniseed.fennel.compiler")
local specials = require("conjure-clj-additions-nrepl.aniseed.fennel.specials")
local repl = require("conjure-clj-additions-nrepl.aniseed.fennel.repl")
local view = require("conjure-clj-additions-nrepl.aniseed.fennel.view")
...
do
  local module_name = "conjure-clj-additions-nrepl.aniseed.fennel.macros"
  local _
