...
local _2amodule_name_2a = "conjure-clj-additions-nrepl.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("conjure-clj-additions-nrepl.aniseed.core"), autoload("conjure-clj-additions-nrepl.aniseed.env"), autoload("conjure-clj-additions-nrepl.aniseed.eval"), autoload("conjure-clj-additions-nrepl.aniseed.nvim")
