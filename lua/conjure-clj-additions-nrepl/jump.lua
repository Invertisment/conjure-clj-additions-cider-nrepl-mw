...
local a, buffer, client, editor, fennel, fs, nvim, str = autoload("conjure-clj-additions-nrepl.aniseed.core"), autoload("conjure.buffer"), autoload("conjure.client"), autoload("conjure.editor"), autoload("fennel"), autoload("conjure.fs"), autoload("conjure.aniseed.nvim"), autoload("conjure.aniseed.string")
