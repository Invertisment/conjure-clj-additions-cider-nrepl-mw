...
local _2amodule_name_2a = "jump-to-cljtest.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("jump-to-cljtest.aniseed.core"), autoload("jump-to-cljtest.aniseed.compile"), autoload("jump-to-cljtest.aniseed.fennel"), autoload("jump-to-cljtest.aniseed.fs"), autoload("jump-to-cljtest.aniseed.nvim")
