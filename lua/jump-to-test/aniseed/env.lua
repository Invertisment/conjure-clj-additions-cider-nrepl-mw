...
local _2amodule_name_2a = "jump-to-test.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("jump-to-test.aniseed.compile"), autoload("jump-to-test.aniseed.fennel"), autoload("jump-to-test.aniseed.fs"), autoload("jump-to-test.aniseed.nvim")
