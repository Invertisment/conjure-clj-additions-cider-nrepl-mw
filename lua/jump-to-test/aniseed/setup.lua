...
local _2amodule_name_2a = "jump-to-test.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("jump-to-test.aniseed.core"), autoload("jump-to-test.aniseed.env"), autoload("jump-to-test.aniseed.eval"), autoload("jump-to-test.aniseed.nvim")
