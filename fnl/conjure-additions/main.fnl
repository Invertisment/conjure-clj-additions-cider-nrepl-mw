...
(defn on-filetype []
  ...
  (provide-fn! :ConjureAdditionsNsRemove :conjure-additions.additional-fns :remove-ns!)
  (provide-fn! :ConjureAdditionsNsCleanup :conjure-additions.additional-fns :cleanup-ns!)
  )
